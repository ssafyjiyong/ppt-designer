...
| LLM | **AWS Bedrock** + Claude Opus 4.6 (글로벌 교차 리전 추론) |
...
```powershell
cd infra
# Opus 4.6 (현재 권장, 기본값 — 글로벌 프로파일)
sam deploy --parameter-overrides BedrockModelId=global.anthropic.claude-opus-4-6-v1
